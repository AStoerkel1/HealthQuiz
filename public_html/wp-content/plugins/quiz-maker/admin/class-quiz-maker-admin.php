...
//                break;
    ...
    public function ays_results_export_filter(){
        ...
        $date_from = isset($_REQUEST['date_from']) ? $_REQUEST['date_from'] : '2000-01-01';
        $date_to = isset($_REQUEST['date_to']) ? $_REQUEST['date_to'] : current_time('Y-m-d');
                    ...
                    if($calc_method == 'by_correctness'){
                        if ($option == true) {
                            $row .= '<tr class="'.$tr_class.'">
                                        ...
                                        <td '.$not_influance_check_td.'>'.__('User answered',$this->plugin_name).':<br/><p class="success">' . htmlentities(do_shortcode(stripslashes($user_answered))) . '</p></td>';
                            if ($not_influance_check) {
                                $row .= '<td>
                            ...
                            $row .= '<tr class="'.$tr_class.'">
                                        <td>'.__('Question',$this->plugin_name).'' . $index . ' :<br/>' . (do_shortcode(stripslashes($question["question"]))) . '</td>
                                        <td>'.__('Correct answer',$this->plugin_name).':<br/><p class="success">' . htmlentities(do_shortcode(stripslashes($correct_answers))) . '<br>'.$correct_answer_images.'</p></td>
                                        <td '.$not_influance_check_td.'>'.__('User answered',$this->plugin_name).':<br/><p class="error">' . htmlentities(do_shortcode(stripslashes($user_answered))) . '</p></td>';
                            if ($not_influance_check) {
                                $row .= '<td>
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
